...
[Metaflow](https://metaflow.org) is a human-friendly Python/R framework for real-life ML, AI, and data science. Originally built at Netflix, now maintained by [Outerbounds](https://outerbounds.com).
